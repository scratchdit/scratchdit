...
if (file_exists(MYBB_ROOT . "inc/settings.php")) {
	include_once MYBB_ROOT . "inc/settings.php";
}
...
<form action="upgrade.php" method="post">
	...
	} else if ($mybb->input['action'] == "doupgrade") {
		add_upgrade_store("allow_anonymous_info", $mybb->get_input('allow_anonymous_info', MyBB::INPUT_INT));
		include_once INSTALL_ROOT . "resources/upgrade" . $mybb->get_input('from', MyBB::INPUT_INT) . ".php";
	...
	} else if ($mybb->input['action'] == "rebuildsettings") {
		$runfunction = "buildsettings";
	} else if ($mybb->input['action'] == "buildcaches") {
		$runfunction = "buildcaches";
	} else if ($mybb->input['action'] == "finished") {
...
function upgradedone()
{
	...
	if ($update_check) {
		...
		include_once MYBB_ROOT . "inc/class_plugins.php";
...
function load_module($module)
{
	...
	include_once INSTALL_ROOT . "resources/" . $module;
