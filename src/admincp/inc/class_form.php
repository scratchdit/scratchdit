...
class DefaultForm
{
	 ...
	 * @param  integer $value   The value of the numeric box.
	 ...
	 * @param  boolean|integer                                            $is_first Is this our first iteration of this function?
	 ...
	 * @param  integer $value       The value that should be checked.
	 * @param  boolean $int         Using integers for the checkbox?
...
class DefaultFormContainer
{
  ...
  */
	 ...
	 *
	 * @return integer The number of rows in the form container.
	 */
	function num_rows()
	{
