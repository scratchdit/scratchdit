 ...
 * @param  integer $parent     The parent ID for this theme (defaults to Master)
 * @return integer The new theme ID
 */
...
/**
 * @param integer       $tid
 * @param boolean|array $theme
 * @param boolean       $update_disporders
 *
 * @return boolean
 */
