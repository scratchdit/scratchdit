...
!(function (t) {
		...
		k = {
			...
			color: {
				...
				format: function (t, e) {
					var n;
					return (
						(v(t, "font") && (n = g(t, "color"))) ||
							(n = t.style.color || p(t, "color")),
						"[color=" + c(n) + "]" + e + "[/color]"
					);
				},
				html: function (t, e, n) {
			...
			quote: {
				...
				format: function (t, e) {
					for (
						var n, r = "data-author", i = "", l = t.children, o = 0;
						!n && o < l.length;
						o++
					)
						v(l[o], "cite") && (n = l[o]);
	...
	function q(t) {
		...
		function d(t, e, n) {
			for (var r = n.length; r--; )
				if (n[r].type === e && n[r].name === t) return !0;
			return !1;
		}
		function p(t, e) {
			var n = (t ? k[t.name] : {}).allowedChildren;
			return (
				!m.opts.fixInvalidChildren ||
				!n ||
				-1 < n.indexOf(e.name || "#")
			);
		}
		...
		(m.opts = n({}, q.defaults, t)),
			(m.tokenize = function (t) {
				...
				t: for (; t.length; ) {
					for (r = l.length; r--; )
						if (
							((n = l[r].type), (e = t.match(l[r].regex)) && e[0])
						) {
	...
	function o(t) {
		return (
			...
			isNaN(t)
				? "00"
				: (t = Math.max(0, Math.min(t, 255)).toString(16)).length < 2
				? "0" + t
				: t
		);
	}
	...
	function f() {
		...
		function t(t, e, n) {
			var r,
				...
				o,
				a,
				s = new q(u.opts.parserOptions).toHTML(
		...
		function e(t, e, n, r) {
			...
			for (
				a.innerHTML = e,
					...
					t &&
						(o.insertBefore(n.createTextNode("#"), o.firstChild),
	...
	(u.prototype = {
		clone: function () {
			...
			return new u(
				...
				n({}, t.attrs),
				[],
				t.closing ? t.closing.clone() : null,
			);
		},
		splitAt: function (t) {
			var e,
