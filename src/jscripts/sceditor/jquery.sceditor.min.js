...
!(function (o) {
	...
	function Me(e, t) {
		for (var n = e || {}; (n = n.parentNode) && !/(9|11)/.test(n.nodeType); ) if (!t || We(n, t)) return n;
	}
	function Ne(e, t) {
	...
	function We(e, t) {
		var n = !1;
		return (
			e && e.nodeType === Ee && (n = (e.matches || e.msMatchesSelector || e.webkitMatchesSelector).call(e, t)), n
		);
	}
	function je(e, t) {
	...
	function et(e, t) {
		var n = (t = t || document).createDocumentFragment(),
			o = De("div", {}, t);
		for (o.innerHTML = e; o.firstChild; ) Fe(n, o.firstChild);
		return n;
	}
	function tt(e) {
	...
	function rt(e, t) {
		var n,
			o = (e || {}).nodeType || Te;
		return o !== Ee ? o === Te : "code" === (n = e.tagName.toLowerCase()) ? !t : s.indexOf("|" + n + "|") < 0;
	}
	function u(e, t) {
	...
	function at(e) {
		...
		if (!/pre(\-wrap)?$/i.test(c))
			for (; u; ) {
				if (
					((a = u.nextSibling), (t = u.nodeValue), (n = u.nodeType) === Ee && u.firstChild && at(u), n === Te)
				) {
					for (o = d(u), r = d(u, !0), l = !1; qe(r, "sceditor-ignore"); ) r = d(r, !0);
					if (rt(u) && r) {
						for (i = r; i.lastChild; ) for (i = i.lastChild; qe(i, "sceditor-ignore"); ) i = d(i, !0);
	...
	var n,
		...
		pt =
			...
			"contentEditable" in document.documentElement &&
				...
				((g = /Opera Mobi|Opera Mini/i.test(v)),
				/Android/i.test(v) &&
					((g = !0), /Safari/.test(v) && (g = !(n = /Safari\/(\d+)/.exec(v)) || !n[1] || n[1] < 534)),
				/ Silk\//i.test(v) && (g = !(n = /AppleWebKit\/(\d+)/.exec(v)) || !n[1] || n[1] < 534),
				ft && (g = /OS [0-4](_\d)+ like Mac/i.test(v)),
				/Firefox/i.test(v) && (g = !1),
				/OneBrowser/i.test(v) && (g = !1),
				"UCWEB" === navigator.vendor && (g = !1),
				y <= 9 && (g = !0),
				!g)),
		b = {
			html:
	...
	var gt = {
			...
			size: {
				_dropDown: function (t, e, n) {
					...
					for (var r = 1; r <= 7; r++) Fe(o, mt("sizeOpt", { size: r }, !0));
				...
				state: function (e, t) {
					...
					return We(t, "li")
						...
						: We(t, "ul,ol,menu") &&
						  ...
						  o !== o.parentNode.firstElementChild || (We(r, "li") && r !== r.parentNode.lastElementChild))
						? 0
						: -1;
				},
				exec: function () {
			...
			table: {
				exec: function (e) {
					var r = this,
						i = De("div");
					Fe(i, mt("table", { rows: r._("Rows:"), cols: r._("Cols:"), insert: r._("Insert") }, !0)),
			...
			unlink: {
				...
				exec: function () {
					...
					if (e) {
						for (; e.firstChild; ) je(e.firstChild, e);
						Re(e);
					}
				},
				tooltip: "Unlink",
			...
			youtube: {
				_dropDown: function (i, e, a) {
					var l = De("div");
					Fe(l, mt("youtubeMenu", { label: i._("Video URL:"), insert: i._("Insert") }, !0)),
				...
				exec: function (e) {
					...
					gt.youtube._dropDown(n, e, function (e, t) {
						n.wysiwygEditorInsertHtml(mt("youtube", { id: e, time: t }));
					});
				},
			...
			ltr: {
				...
				exec: function () {
					...
					(this.focus(),
					(t && !We(t, "body")) ||
						(this.execCommand("formatBlock", "p"), (t = e.getFirstBlockParent()) && !We(t, "body"))) &&
		...
		var r = this,
			...
			e = function (e, t) {
				...
				var n,
					o,
					r = l(e.shift());
				for (n = 0; n < a.length; n++) if (r in a[n] && ((o = a[n][r].apply(i, e)), t)) return o;
			};
		(r.call = function () {
			e(arguments, !1);
		}),
			...
			(r.isRegistered = function (e) {
				if (r.exists(e)) for (var t = a.length; t--; ) if (a[t] instanceof C[e]) return !0;
				return !1;
			}),
			(r.register = function (e) {
				return (
					!(!r.exists(e) || r.isRegistered(e)) &&
					((e = new C[e]()), a.push(e), "init" in e && e.init.call(i), !0)
				);
			}),
			(r.deregister = function (e) {
				...
				for (; n--; )
					a[n] instanceof C[e] && ((o = !0), "destroy" in (t = a.splice(n, 1)[0]) && t.destroy.call(i));
				return o;
			}),
			(r.destroy = function () {
				for (var e = a.length; e--; ) "destroy" in a[e] && a[e].destroy.call(i);
				(a = []), (i = null);
			});
	}
	ht.plugins = C;
		...
		S = function (e, t, n) {
			...
			for (
				...
				(o = s.nodeValue),
					...
					(l = s),
					t
						? ((u = i = Math.max(a - r, 0)), (c = o.substr(i, a - i) + c), (s = l.previousSibling))
						: ((u = i + (a = Math.min(r, o.length))), (c += o.substr(i, a)), (s = l.nextSibling));
	...
	function vt(i, e) {
		...
		(y.insertHTML = function (e, t) {
			...
			for (
				t && (e += y.selectedHtml() + t), o = De("p", {}, c), n = c.createDocumentFragment(), o.innerHTML = e;
				o.firstChild;
			...
			(l = function (e, t, n) {
				...
				if (
					("string" == typeof e
						...
						: (Fe(r, e), t && (Fe(r, y.selectedRange().extractContents()), Fe(r, t))),
					(o = r.lastChild))
				) {
					for (; !rt(o.lastChild, !0); ) o = o.lastChild;
					if (
						(ot(o) ? o.lastChild || Fe(o, document.createTextNode("​")) : (o = r),
						y.removeMarkers(),
						Fe(o, a(s)),
						Fe(o, a(u)),
						n)
			...
			(y.selectRange = function (e) {
				var t,
					n = i.getSelection(),
					o = e.endContainer;
				if (!k && e.collapsed && o && !rt(o, !0)) {
					for (t = o.lastChild; t && We(t, ".sceditor-ignore"); ) t = t.previousSibling;
					if (We(t, "br")) {
						var r = c.createRange();
			...
			(y.replaceKeyword = function (e, t, n, o, r, i) {
				...
				for (
					...
					if (
						...
						(c = -1),
						r
							? (l = a.substr(s).match(new RegExp(m + st(f) + m))) && (c = l.index + s + l[1].length)
							: (c = a.indexOf(f, s)),
						-1 < c && c <= u && u <= c + p + h)
					)
						return (
		...
		(de.opts.emoticons = e.emoticons || ct.emoticons),
			(M = function () {
				(l._sceditor = de),
					...
					je((w = De("div", { className: "sceditor-container" })), l),
			...
			(z = function () {
				var e;
				(t = kt.locale[ye.locale]) || ((e = ye.locale.split("-")), (t = kt.locale[e[0]])),
					t && t.dateFormat && (ye.dateFormat = t.dateFormat);
			}),
			(H = function () {
				(s = De("textarea")),
					(c = De("iframe", { frameborder: 0, allowfullscreen: !0 })),
					ye.startInSourceMode ? (Ue(w, "sourceMode"), Be(c)) : (Ue(w, "wysiwygMode"), Be(s)),
				...
				(e += ft ? " ios" : ""),
					...
					(ft || dt || xt) && (Xe(m, "100%"), xt || ze(m, "touchend", de.focus));
				var t = Ae(l, "tabindex");
			...
			(A = function () {
				ye.autoUpdate && (ze(m, "blur", se), ze(s, "blur", se)),
					null === ye.rtl && (ye.rtl = "rtl" === Pe(s, "direction")),
					de.rtl(!!ye.rtl),
					ye.autoExpand && (ze(m, "load", ue, _e), ze(m, "input keyup", ue)),
					ye.resizeEnabled && I(),
					Ae(w, "id", ye.id),
							...
							Se(t.split(","), function (e, t) {
								...
								if (r && !(-1 < l.indexOf(t))) {
									if (
										...
										(n = mt(
											"toolbarButton",
											{ name: t, dispName: de._(r.name || r.tooltip || t) },
											!0,
										).firstChild),
										D && D.create)
									)
										D.create(t) && (je(D.create(t), n.firstChild), Ue(n, "has-icon"));
									(n._sceTxtMode = !!r.txtExec),
										(n._sceWysiwygMode = !!r.exec),
										Ye(n, "disabled", !r.exec),
										ze(n, "click", function (e) {
											qe(n, "disabled") || R(n, r), G(), e.preventDefault();
										}),
										...
										r.state
											? me.push({ name: t, state: r.state })
											: be(r.exec) && me.push({ name: t, state: r.exec }),
										Fe(i, n),
										(he[t] = n);
								}
							}),
			...
			(I = function () {
				...
				if (
					...
					(n = function (e) {
						y && ((y = !1), Be(l), $e(w, "resizing"), Oe(bt, c, t), Oe(bt, s, n), e.preventDefault());
					}),
					D && D.create)
				) {
					var x = D.create("grip");
			...
			(ne = function () {
				...
				if (Ge(w)) {
					...
					if ((at(m), o))
						for ((n = m.lastChild) || ((n = De("p", {}, d)), Fe(m, n)); n.lastChild; )
			...
			(de.readOnly = function (e) {
				return "boolean" != typeof e ? !s.readonly : ((m.contentEditable = !e), (s.readonly = !e), Q(e), de);
			}),
			(de.rtl = function (e) {
				var t = e ? "rtl" : "ltr";
			...
			(de.expandToContent = function (e) {
				if (!de.maximize()) {
					if ((clearTimeout(S), (S = !1), !k)) {
						...
						k = { min: t, max: ye.resizeMaxHeight || 2 * t };
					}
			...
			(de.destroy = function () {
				if (r) {
					...
					var e = l.form;
					e && (Oe(e, "reset", U), Oe(e, "submit", de.updateOriginal)),
						Re(s),
						Re(u),
						Re(w),
						delete l._sceditor,
			...
			(de.createDropDown = function (e, t, n, o) {
				...
				de.closeDropDown(!0),
					(f && qe(f, i)) ||
						(!1 !== o &&
							Se(He(n, ":not(input):not(textarea)"), function (e, t) {
						...
						Pe((f = De("div", { className: "sceditor-dropdown " + i })), r),
						Fe(f, n),
						Fe(w, f),
			...
			(P = function (e) {
				...
				if (i && !o) {
					...
					var u = r.scrollTop;
					for (v.saveRange(), T = bt.createDocumentFragment(); r.firstChild; ) Fe(T, r.firstChild);
					setTimeout(function () {
						var e = r.innerHTML;
						(r.innerHTML = ""), Fe(r, T), (r.scrollTop = u), (T = !1), v.restoreRange(), V({ html: e });
					}, 0);
				}
			}),
			(V = function (e) {
			...
			(de.sourceEditorInsertText = function (e, t) {
				...
				(n = s.scrollTop),
					...
					(s.value = o.substring(0, r) + e + o.substring(i, o.length)),
			...
			(de.insert = function (e, t, n, o, r) {
				...
				return (
					!1 !== n && "fragmentToHtml" in a && (e = a.fragmentToHtml(e, y)),
			...
			(de.getWysiwygEditorValue = function (e) {
				for (var t, n = De("div", {}, d), o = m.childNodes, r = 0; r < o.length; r++) Fe(n, o[r].cloneNode(!0));
				return (
					Fe(m, n),
					it(n),
					Re(n),
			...
			(de.setWysiwygEditorValue = function (e) {
				e || (e = "<p>" + (xt ? "" : "<br />") + "</p>"), (m.innerHTML = e), N(), Z(), ae(), ue();
			}),
					...
					Me(e, "code") ||
						...
						(function e(t) {
							for (t = t.firstChild; t; ) {
								if ((t.nodeType !== Ee || We(t, "code") || e(t), t.nodeType === Te))
							...
							e &&
								...
								Je(
									...
									function (e) {
										rt(e, !0)
											? (o || je((o = De("p", {}, n)), e),
											  (e.nodeType === Te && "" === e.nodeValue) || Fe(o, e))
											: (o = null);
									},
									!1,
									!0,
			...
			(de.emoticons = function (e) {
				...
				(ye.emoticonsEnabled = e)
					? (ze(m, "keypress", oe), de.sourceMode() || (v.saveRange(), N(), ae(!1), v.restoreRange()))
					: (Se(He(m, "img[data-sceditor-emoticon]"), function (e, t) {
			...
			(de.css = function (e) {
				return (
					o || ((o = De("style", { id: "inline" }, d)), Fe(d.head, o)),
					be(e)
			...
			(W = function (e) {
				...
				(e.ctrlKey || e.metaKey) && t.push("ctrl"),
					...
					(t = t.join("+")),
					ge[t] && !1 === ge[t].call(de) && (e.stopPropagation(), e.preventDefault());
			}),
			...
			(j = function (e) {
				...
				if (
					...
					8 === e.which &&
					(n = v.selectedRange()) &&
					((t = n.startContainer), 0 === n.startOffset && (o = ie()) && !We(o, "body"))
				) {
					for (; t !== o; ) {
			...
			(ie = function () {
				for (var e = b; !tt(e) || rt(e, !0); ) if (!(e = e.parentNode) || We(e, "body")) return;
				return e;
			}),
			...
			(ae = function (e) {
				if (r && (r.hasHandler("valuechangedEvent") || ae.hasHandler)) {
					...
					(e = (g = !1) !== e && !d.getElementById("sceditor-start-marker")),
						...
						o && e && v.saveRange(),
						(t = n ? s.value : m.innerHTML) !== ae.lastVal &&
	...
	(kt.locale = {}),
		...
		(window.sceditor = {
			...
			formats: kt.formats,
			create: function (e, t) {
				(t = t || {}), Me(e, ".sceditor-container") || ((t.runWithoutWysiwygSupport || pt) && new kt(e, t));
			},
			instance: function (e) {
				return e._sceditor;
			},
