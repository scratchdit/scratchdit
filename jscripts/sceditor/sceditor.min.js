...
!(function () {
	...
	var n,
		...
		ft = /iPhone|iPod|iPad| wosbrowser\//i.test(h),
		pt =
			(((g = document.createElement("div")).contentEditable = !0),
			"contentEditable" in document.documentElement &&
				"true" === g.contentEditable &&
				((m = /Opera Mobi|Opera Mini/i.test(h)),
				/Android/i.test(h) &&
					((m = !0), /Safari/.test(h) && (m = !(n = /Safari\/(\d+)/.exec(h)) || !n[1] || n[1] < 534)),
				/ Silk\//i.test(h) && (m = !(n = /AppleWebKit\/(\d+)/.exec(h)) || !n[1] || n[1] < 534),
				ft && (m = /OS [0-4](_\d)+ like Mac/i.test(h)),
				/Firefox/i.test(h) && (m = !1),
				/OneBrowser/i.test(h) && (m = !1),
					...
					Fe(i, mt("table", { rows: r._("Rows:"), cols: r._("Cols:"), insert: r._("Insert") }, !0)),
						ze(i, "click", ".button", function (e) {
							...
							0 < t &&
								0 < n &&
								((o += Array(t + 1).join(
									"<tr>" + Array(n + 1).join("<td>" + (b ? "" : "<br />") + "</td>") + "</tr>",
								)),
								(o += "</table>"),
			...
			quote: {
				exec: function (e, t, n) {
					...
					t
						...
						: "" === this.getRangeHelper().selectedHtml() && (r = (b ? "" : "<br />") + r),
	...
	function ht(i) {
		...
		(r.call = function () {
			...
			(r.isRegistered = function (e) {
				if (r.exists(e)) for (var t = a.length; t--; ) if (a[t] instanceof w[e]) return !0;
				return !1;
			}),
			(r.register = function (e) {
				return (
					!(!r.exists(e) || r.isRegistered(e)) &&
					((e = new w[e]()), a.push(e), "init" in e && e.init.call(i), !0)
				);
			}),
		...
		(de.opts.emoticons = e.emoticons || ct.emoticons),
			...
			(te = function () {
				...
				y !== t &&
					...
					Ge(w, "nodechanged", { oldNode: e, newNode: y }));
			}),
				...
				if (r && (r.hasHandler("valuechangedEvent") || ae.hasHandler)) {
					...
					(e = (g = !1) !== e && !d.getElementById("sceditor-start-marker")),
						...
						(t = n ? s.value : m.innerHTML) !== ae.lastVal &&
							((ae.lastVal = t), Ge(w, "valuechanged", { rawValue: n ? de.val() : t })),
						o && e && v.removeMarkers();
				}
			}),
			(le = function () {
