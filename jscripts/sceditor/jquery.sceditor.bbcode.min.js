...
!(function (o) {
	...
	function Ee(t, n) {
		if (Array.isArray(t) || ("length" in t && r(t.length))) for (var e = 0; e < t.length; e++) n(e, t[e]);
		else
	...
	function qe(e, t) {
		var n = !1;
		return (
			e && e.nodeType === Se && (n = (e.matches || e.msMatchesSelector || e.webkitMatchesSelector).call(e, t)), n
		);
	}
	function Ve(e, t) {
	...
	function lt(e) {
		...
		if (!/pre(\-wrap)?$/i.test(s))
			for (; u; ) {
				if (
					((l = u.nextSibling), (t = u.nodeValue), (n = u.nodeType) === Se && u.firstChild && lt(u), n === Te)
				) {
					...
					(t = t.replace(/\u200B/g, "")),
						(r && rt(r) && !a) || (t = t.replace(c ? /^[\t ]+/ : /^[\t\n\r ]+/, "")),
						(o && rt(o)) || (t = t.replace(c ? /[\t ]+$/ : /[\t\n\r ]+$/, "")),
						t.length ? (u.nodeValue = t.replace(c ? /[\t ]+/g : /[\t\n\r ]+/g, " ")) : Be(u);
				}
				u = l;
			}
	}
	...
	function p(e, t) {
		...
		if (
			...
			if (
				((n = r.direction),
				(o = o || je(e, t)),
				je(e.parentNode, t) === o || "block" !== je(e, "display") || qe(e, "hr,th"))
			)
				return "";
	...
	var n,
		...
		pt =
			(((g = document.createElement("div")).contentEditable = !0),
			"contentEditable" in document.documentElement &&
				"true" === g.contentEditable &&
	...
	function w(e) {
		if ("mozHidden" in document)
			for (var t, n = e.getBody(); n; ) {
				...
				3 === n.nodeType &&
					/[\n\r\t]+/.test(n.nodeValue) &&
					(/^pre/.test(je(n.parentNode, "whiteSpace")) || Be(n)),
					(n = t);
			}
	}
	var mt = {
				...
				state: function (e, t) {
					...
					return qe(t, "li")
						...
						: qe(t, "ul,ol,menu") &&
						  ...
						  o !== o.parentNode.firstElementChild || (qe(r, "li") && r !== r.parentNode.lastElementChild))
						? 0
						: -1;
				},
				exec: function () {
			...
			table: {
				exec: function (e) {
					var r = this,
						i = De("div");
					Re(i, ht("table", { rows: r._("Rows:"), cols: r._("Cols:"), insert: r._("Insert") }, !0)),
						Fe(i, "click", ".button", function (e) {
			...
			quote: {
				exec: function (e, t, n) {
					var o = "<blockquote>",
						r = "</blockquote>";
					t
						? ((o = o + (n = n ? "<cite>" + ut(n) + "</cite>" : "") + t + r), (r = null))
						: "" === this.getRangeHelper().selectedHtml() && (r = (x ? "" : "<br />") + r),
			...
			youtube: {
				_dropDown: function (i, e, l) {
					var a = De("div");
					Re(a, ht("youtubeMenu", { label: i._("Video URL:"), insert: i._("Insert") }, !0)),
						Fe(a, "click", ".button", function (e) {
							var t = He(a, "#link")[0].value,
								n = t.match(/(?:v=|v\/|embed\/|youtu.be\/)(.{11})/),
								o = t.match(/[&|?](?:star)?t=((\d+[hms]?){1,3})/),
								r = 0;
							o &&
								Ee(o[1].split(/[hms]/), function (e, t) {
									"" !== t && (r = 60 * r + Number(t));
								}),
								n && /^[a-zA-Z0-9_\-]{11}$/.test(n[1]) && l(n[1], r),
								i.closeDropDown(!0),
								e.preventDefault();
						}),
			...
			ltr: {
				...
				exec: function () {
					...
					this.focus(),
						((t && !qe(t, "body")) ||
							(this.execCommand("formatBlock", "p"), (t = e.getFirstBlockParent()) && !qe(t, "body"))) &&
							je(t, "direction", "ltr" === je(t, "direction") ? "" : "ltr");
				},
			...
			rtl: {
				...
				exec: function () {
					...
					this.focus(),
						((t && !qe(t, "body")) ||
							(this.execCommand("formatBlock", "p"), (t = e.getFirstBlockParent()) && !qe(t, "body"))) &&
							je(t, "direction", "rtl" === je(t, "direction") ? "" : "rtl");
				},
		...
		(r.call = function () {
			...
			(r.register = function (e) {
				return !(
					!r.exists(e) ||
					r.isRegistered(e) ||
					((e = new k[e]()), l.push(e), "init" in e && e.init.call(i), 0)
				);
			}),
			(r.deregister = function (e) {
				...
				for (; n--; )
					l[n] instanceof k[e] && ((o = !0), "destroy" in (t = l.splice(n, 1)[0]) && t.destroy.call(i));
				return o;
			}),
			(r.destroy = function () {
	...
	var C = y && y < 11,
		E = function (e, t, n) {
			var o,
				...
				u = e.startOffset;
			for (
				c && 3 !== c.nodeType && ((c = c.childNodes[u]), (u = 0)), i = l = u;
				n > s.length && c && 3 === c.nodeType;
				...
				(o = c.nodeValue),
					...
					(a = c),
					t
						? ((u = i = Math.max(l - r, 0)), (s = o.substr(i, l - i) + s), (c = a.previousSibling))
						: ((u = i + (l = Math.min(r, o.length))), (s += o.substr(i, l)), (c = a.nextSibling));
			return { node: a || c, offset: u, text: s };
		};
	function vt(i, e) {
		var l,
			a,
			s = e || i.contentDocument || i.document,
		...
		(y.insertHTML = function (e, t) {
			...
			for (
				t && (e += y.selectedHtml() + t), o = De("p", {}, s), n = s.createDocumentFragment(), o.innerHTML = e;
				o.firstChild;
			...
			(a = function (e, t, n) {
				...
				if (
					("string" == typeof e
						? (t && (e += y.selectedHtml() + t), (r = et(e)))
						: (Re(r, e), t && (Re(r, y.selectedRange().extractContents()), Re(r, t))),
					(o = r.lastChild))
				) {
					for (; !rt(o.lastChild, !0); ) o = o.lastChild;
					if (
						(ot(o) ? o.lastChild || Re(o, document.createTextNode("​")) : (o = r),
						y.removeMarkers(),
						Re(o, l(c)),
						Re(o, l(u)),
						n)
			...
			(y.insertMarkers = function () {
				...
				y.removeMarkers(),
					y.insertNodeAt(!0, t),
					e && e.collapsed ? t.parentNode.insertBefore(l(u), t.nextSibling) : y.insertNodeAt(!1, l(u));
			}),
			...
			(y.restoreRange = function () {
				...
				if (!n || !o || !t) return !1;
				(e = n.nextSibling === o),
					(t = s.createRange()).setStartBefore(n),
					t.setEndAfter(o),
					e && t.collapse(!0),
					y.selectRange(t),
					y.removeMarkers();
			...
			(y.replaceKeyword = function (e, t, n, o, r, i) {
				...
				for (
					r && v++,
						i = i || "",
						u = (l = y.getOuterText(!0, v)).length,
						l += i,
						t && (l += y.getOuterText(!1, v));
					m--;
					...
					if (
						...
						(s = -1),
						r
							? (a = l.substr(c).match(new RegExp(h + ct(f) + h))) && (s = a.index + c + a[1].length)
							: (s = l.indexOf(f, c)),
						-1 < s && s <= u && u <= s + p + g)
					)
						return (
	...
	function Ct(a, e) {
		...
		(de.opts.emoticons = e.emoticons || st.emoticons),
			(M = function () {
				(a._sceditor = de),
					ye.locale && "en" !== ye.locale && F(),
					Ve((w = De("div", { className: "sceditor-container" })), a),
					je(w, "z-index", ye.zIndex),
					xt && $e(w, "ie ie" + xt),
					(n = a.required),
					(a.required = !1);
				var e = Ct.formats[ye.format];
				"init" in (l = e ? new e() : {}) && l.init.call(de),
					I(),
					L(),
					z(),
					H(),
				...
				var t = function () {
					ze(yt, "load", t),
						...
						Z(),
						r.call("ready"),
						"onReady" in l && l.onReady.call(de);
				};
			...
			(F = function () {
				var e;
				(t = Ct.locale[ye.locale]) || ((e = ye.locale.split("-")), (t = Ct.locale[e[0]])),
					t && t.dateFormat && (ye.dateFormat = t.dateFormat);
			}),
			(H = function () {
				(c = De("textarea")),
					(s = De("iframe", { frameborder: 0, allowfullscreen: !0 })),
					ye.startInSourceMode ? ($e(w, "sourceMode"), Oe(s)) : ($e(w, "wysiwygMode"), Oe(c)),
					ye.spellcheck || Ae(w, "spellcheck", "false"),
					"https:" === yt.location.protocol && Ae(s, "src", "javascript:false"),
					Re(w, s),
					Re(w, c),
					de.dimensions(ye.width || Ke(a), ye.height || Xe(a));
				var e = xt ? "ie ie" + xt : "";
				(e += ft ? " ios" : ""),
					(d = s.contentDocument).open(),
					d.write(
						ht("html", {
							attrs: ' class="' + e + '"',
					...
					(ft || dt || xt) && (Xe(h, "100%"), xt || Fe(h, "touchend", de.focus));
				var t = Ae(a, "tabindex");
			...
			(A = function () {
				ye.autoUpdate && (Fe(h, "blur", ce), Fe(c, "blur", ce)),
					null === ye.rtl && (ye.rtl = "rtl" === je(c, "direction")),
					de.rtl(!!ye.rtl),
					ye.autoExpand && (Fe(h, "load", ue, Ie), Fe(h, "input keyup", ue)),
					ye.resizeEnabled && _(),
					Ae(w, "id", ye.id),
			...
			(O = function () {
				...
				Fe(bt, "click", X),
					e && (Fe(e, "reset", $), Fe(e, "submit", de.updateOriginal, Ie)),
					Fe(h, "keypress", W),
					Fe(h, "keydown", q),
					Fe(h, "keydown", V),
					Fe(h, "keyup", Z),
					...
					Fe(h, o, ee),
					Fe(h, n, K),
					ye.emoticonsCompat && yt.getSelection && Fe(h, "keyup", re),
					Fe(h, "blur", function () {
					...
					Fe(d, "mousedown", U),
					Fe(d, o, ee),
					Fe(d, "beforedeactivate keyup mouseup", R),
					Fe(d, "keyup", Z),
					Fe(d, "focus", function () {
						p = null;
					}),
					Fe(w, "selectionchanged", te),
					Fe(w, "selectionchanged", G),
					Fe(w, "selectionchanged valuechanged nodechanged pasteraw paste", K);
			}),
			(z = function () {
				var i,
					l = de.commands,
				...
				(u = De("div", { className: "sceditor-toolbar", unselectable: "on" })),
					ye.icons in Ct.icons && (D = new Ct.icons[ye.icons]()),
					Ee(e, function (e, t) {
						(i = De("div", { className: "sceditor-group" })),
							Ee(t.split(","), function (e, t) {
								...
								!r ||
									-1 < a.indexOf(t) ||
									((o = r.shortcut),
									(n = ht("toolbarButton", { name: t, dispName: de._(r.name || r.tooltip || t) }, !0)
										.firstChild),
									D && D.create && D.create(t) && (Ve(D.create(t), n.firstChild), $e(n, "has-icon")),
									(n._sceTxtMode = !!r.txtExec),
									(n._sceWysiwygMode = !!r.exec),
									Ye(n, "disabled", !r.exec),
									Fe(n, "click", function (e) {
									...
									r.state
										? he.push({ name: t, state: r.state })
										: be(r.exec) && he.push({ name: t, state: r.exec }),
									Re(i, n),
									(ge[t] = n));
							}),
							i.firstChild && Re(u, i);
			...
			(_ = function () {
				var o,
					...
					a = De("div", { className: "sceditor-resize-cover" }),
					...
					b = de.rtl();
				if (
					((o = ye.resizeMinHeight || v / 1.5),
					(r = ye.resizeMaxHeight || 2.5 * v),
					(i = ye.resizeMinWidth || g / 1.25),
					(l = ye.resizeMaxWidth || 1.25 * g),
					(t = function (e) {
						"touchmove" === e.type
							? ((e = yt.event), (f = e.changedTouches[0].pageX), (p = e.changedTouches[0].pageY))
							: ((f = e.pageX), (p = e.pageY));
						var t = m + (p - d),
							n = b ? h - (f - u) : h + (f - u);
						0 < l && l < n && (n = l),
				...
				Re(w, e),
					Re(w, a),
					Oe(a),
					Fe(e, "touchstart mousedown", function (e) {
						"touchstart" === e.type
							? ((e = yt.event), (u = e.touches[0].pageX), (d = e.touches[0].pageY))
							: ((u = e.pageX), (d = e.pageY)),
							(h = Ke(w)),
							(m = Xe(w)),
							(y = !0),
			...
			(L = function () {
				var e = ye.emoticons,
					n = ye.emoticonsRoot || "";
				e && (ve = ke({}, e.more, e.dropdown, e.hidden)),
					Ee(ve, function (e, t) {
						(ve[e] = ht("emoticon", {
							key: e,
							url: n + (t.url || t),
			...
			(ne = function () {
				...
				if (Ge(w)) {
					...
					if ((lt(h), o))
						for ((n = h.lastChild) || ((n = De("p", {}, d)), Re(h, n)); n.lastChild; )
							(n = n.lastChild), !wt && qe(n, "br") && n.previousSibling && (n = n.previousSibling);
					(e = d.createRange()),
			...
			(de.dimensions = function (e, t, n) {
				return (
					...
					!1 === (e = !(!e && 0 !== e) && e) && !1 === t
						...
						: (!1 !== e && (!1 !== n && (ye.width = e), Ke(w, e)),
						  !1 !== t && (!1 !== n && (ye.height = t), Xe(w, t)),
						  de)
				);
			}),
			...
			(de.destroy = function () {
				if (r) {
					...
					var e = a.form;
					e && (ze(e, "reset", $), ze(e, "submit", de.updateOriginal)),
						Be(c),
						Be(u),
						Be(w),
						delete a._sceditor,
			...
			(de.createDropDown = function (e, t, n, o) {
				...
				de.closeDropDown(!0),
					(f && We(f, i)) ||
						(!1 !== o &&
							Ee(He(n, ":not(input):not(textarea)"), function (e, t) {
						...
						je((f = De("div", { className: "sceditor-dropdown " + i })), r),
						Re(f, n),
						Re(w, f),
						Fe(f, "click focusin", function (e) {
							e.stopPropagation();
						}),
						setTimeout(function () {
							if (f) {
			...
			(P = function (e) {
				...
				r.call("pasteRaw", e),
					Qe(w, "pasteraw", e),
					e.html ? ((t.innerHTML = e.html), it(t)) : (t.innerHTML = ut(e.text || ""));
				var n = { val: t.innerHTML };
				"fragmentToSource" in l && (n.val = l.fragmentToSource(n.val, d, y)),
					r.call("paste", n),
					Qe(w, "paste", n),
					"fragmentToHtml" in l && (n.val = l.fragmentToHtml(n.val, y)),
					r.call("pasteHtml", n),
			...
			(de.wysiwygEditorInsertHtml = function (e, t, n) {
				...
				de.focus(),
					(!n && Ne(b, "code")) ||
						...
						v.saveRange(),
						N(),
						_e((o = He(h, "#sceditor-end-marker")[0])),
						(r = h.scrollTop),
						(i = at(o).top + 1.5 * o.offsetHeight - l),
						Oe(o),
						(r < i || i + l < r) && (h.scrollTop = i),
						le(!1),
						v.restoreRange(),
						Z());
			}),
			...
			(de.sourceEditorInsertText = function (e, t) {
				...
				(n = c.scrollTop),
					...
					(c.value = o.substring(0, r) + e + o.substring(i, o.length)),
					(c.selectionStart = r + e.length - (t ? t.length : 0)),
			...
			(de.sourceEditorCaret = function (e) {
				return (
					c.focus(),
					e
						? ((c.selectionStart = e.start), (c.selectionEnd = e.end), this)
			...
			(de.val = function (e, t) {
				return be(e)
					? (de.inSourceMode()
							...
							: (!1 !== t && "toHtml" in l && (e = l.toHtml(e)), de.setWysiwygEditorValue(e)),
					  de)
					: de.inSourceMode()
			...
			(de.insert = function (e, t, n, o, r) {
				...
				return (
					!1 !== n && "fragmentToHtml" in l && (e = l.fragmentToHtml(e, y)),
			...
			(de.getWysiwygEditorValue = function (e) {
				...
				return (
					...
					Be(n),
					(t = n.innerHTML),
					!1 !== e && l.hasOwnProperty("toSource") && (t = l.toSource(t, d)),
					t
				);
			}),
			(de.getBody = function () {
					...
					if (i.getSelection() && i.getSelection().rangeCount <= 0) x = null;
						...
						if ((x = v.cloneSelected()) && x.collapsed) {
							var e = x.startContainer,
								t = x.startOffset;
							for (t && e.nodeType !== Te && (e = e.childNodes[t]); e && e.parentNode !== h; )
								e = e.parentNode;
							e &&
								rt(e, !0) &&
								(v.saveRange(),
								...
								Je(
									...
									function (e) {
										rt(e, !0)
											? (o || Ve((o = De("p", {}, n)), e),
											  (e.nodeType === Te && "" === e.nodeValue) || Re(o, e))
											: (o = null);
									},
									!1,
									!0,
			...
			(te = function () {
				...
				y !== t &&
					...
					Qe(w, "nodechanged", { oldNode: e, newNode: y }));
			}),
				...
				if (de.readOnly())
					...
					for (var i = 0; i < he.length; i++) {
						...
						if (be(s)) {
							if (!r)
								try {
									-1 < (l = o.queryCommandEnabled(s) ? 0 : -1) &&
										(l = o.queryCommandState(s) ? 1 : 0);
								} catch (e) {}
			...
			(W = function (e) {
				if (!e.defaultPrevented && (de.closeDropDown(), 13 === e.which) && !qe(b, "li,ul,ol") && tt(b)) {
					...
					if ((v.insertNode(t), !wt)) {
						var n = t.parentNode,
							o = n.lastChild;
						o && o.nodeType === Te && "" === o.nodeValue && (Be(o), (o = n.lastChild)),
			...
			(de.bind = function (e, t, n, o) {
				for (var r = (e = e.split(" ")).length; r--; )
					if (we(t)) {
						var i = "scewys" + e[r],
							l = "scesrc" + e[r];
						n || ((fe[i] = fe[i] || []), fe[i].push(t)),
							o || ((fe[l] = fe[l] || []), fe[l].push(t)),
							"valuechanged" === e[r] && (le.hasHandler = !0);
					}
				return de;
			}),
			(de.unbind = function (e, t, n, o) {
				for (var r = (e = e.split(" ")).length; r--; )
					we(t) && (n || Ce(fe["scewys" + e[r]] || [], t), o || Ce(fe["scesrc" + e[r]] || [], t));
				return de;
			}),
				...
				if (we(e)) de.bind("focus", e, t, n);
					...
					x || ne(),
						!wt &&
							...
							qe(o.firstChild, "br") &&
							(r.setStartBefore(o.firstChild), r.collapse(!0), v.selectRange(r)),
						i.focus(),
						h.focus(),
			...
			(oe = function (e) {
				...
				Ne(b, "code") ||
					...
					v.replaceKeyword(de.emoticonsCache, !0, !0, de.longestEmoticonCode, ye.emoticonsCompat, t) &&
						((ye.emoticonsCompat && /^\s$/.test(t)) || e.preventDefault()));
			}),
			(re = function () {
				!(function (e, t) {
					var n = /[^\s\xA0\u2002\u2003\u2009\u00a0]+/,
						...
						for (var r = 0; r < o.length; r++) {
							...
							if ((a && n.test(a.nodeValue.slice(-1))) || (s && n.test((s.nodeValue || "")[0]))) {
								var c = t.cloneSelected(),
									...
									d = c.startContainer,
									f = a.nodeValue;
								null === f && (f = a.innerText || ""),
									(f += Pe(i, "sceditor-emoticon")),
									d === s && (u = f.length + c.startOffset),
									d === e && e.childNodes[c.startOffset] === s && (u = f.length),
									d === a && (u = c.startOffset),
									(s && s.nodeType === Te) ||
										(s = l.insertBefore(l.ownerDocument.createTextNode(""), s)),
									s.insertData(0, f),
									Be(a),
									Be(i),
									-1 < u && (c.setStart(s, u), c.collapse(!0), t.selectRange(c));
							}
						}
				})(b, v);
			}),
			(de.emoticons = function (e) {
				return e || !1 === e
					? ((ye.emoticonsEnabled = e)
							? (Fe(h, "keypress", oe), de.sourceMode() || (v.saveRange(), N(), le(!1), v.restoreRange()))
							: (Ee(He(h, "img[data-sceditor-emoticon]"), function (e, t) {
			...
			(de.css = function (e) {
				return (
					o || ((o = De("style", { id: "inline" }, d)), Re(d.head, o)),
					be(e)
			...
			(V = function (e) {
				var t, n, o;
				if (
					!ye.disableBlockRemove &&
					8 === e.which &&
					(n = v.selectedRange()) &&
					((t = n.startContainer), 0 === n.startOffset && (o = ie()) && !qe(o, "body"))
				) {
					for (; t !== o; ) {
			...
			(le = function (e) {
				if (r && (r.hasHandler("valuechangedEvent") || le.hasHandler)) {
					...
					(e = (m = !1) !== e && !d.getElementById("sceditor-start-marker")),
						...
						o && e && v.saveRange(),
						(t = n ? c.value : h.innerHTML) !== le.lastVal &&
							((le.lastVal = t), Qe(w, "valuechanged", { rawValue: n ? de.val() : t })),
						o && e && v.removeMarkers();
				}
			}),
			(ae = function () {
					...
					m ||
						(13 === t || 32 === t
							...
							? r
								? (se.triggerNext = !0)
								: le()
							: se.triggerNext && (le(), (se.triggerNext = !1)),
						clearTimeout(g),
	...
	(function (e) {
			...
			w = {
				...
				font: {
					...
					format: function (e, t) {
						var n;
						return (
							(v(e, "font") && (n = g(e, "face"))) || (n = m(e, "font-family")),
							"[font=" + E(n) + "]" + t + "[/font]"
						);
					},
				...
				color: {
					...
					format: function (e, t) {
						var n;
						return (
							(v(e, "font") && (n = g(e, "color"))) || (n = e.style.color || m(e, "color")),
							"[color=" + u(n) + "]" + t + "[/color]"
						);
					},
					html: function (e, t, n) {
				...
				img: {
					...
					format: function (t, e) {
						...
						return g(t, b)
							? e
							: ((n = g(t, "width") || i("width")),
							  (o = g(t, "height") || i("height")),
							  ((t.complete && (n || o)) || (n && o)) && (r = "=" + h.width(t) + "x" + h.height(t)),
							  "[img" + r + "]" + g(t, "src") + "[/img]");
					},
					html: function (e, t, n) {
						var o,
						...
						return (
							...
							(r = t.height),
							t.defaultattr &&
								((o = (i = t.defaultattr.split(/x/i))[0]), (r = 2 === i.length ? i[1] : i[0])),
							void 0 !== o && (l += ' width="' + f(o, !0) + '"'),
							void 0 !== r && (l += ' height="' + f(r, !0) + '"'),
							"<img" + l + ' src="' + a(n) + '" />'
						);
					},
				},
				url: {
					...
					html: function (e, t, n) {
						return (
							(t.defaultattr = f(t.defaultattr, !0) || n),
				...
				quote: {
					...
					quoteType: x.never,
					format: function (e, t) {
						for (var n, o = "data-author", r = "", i = e.children, l = 0; !n && l < i.length; l++)
							v(i[l], "cite") && (n = i[l]);
						return (
							(n || g(e, o)) &&
								((r = (n && n.textContent) || g(e, o)),
								g(e, o, r),
								n && e.removeChild(n),
					...
					html: function (e, t, n) {
						return (
							t.defaultattr && (n = "<cite>" + f(t.defaultattr) + "</cite>" + n),
						...
						n[2] &&
							...
							(o = (function (e) {
								...
								if ("=" === e.charAt(0) && e.indexOf("=", 1) < 0) o.defaultattr = E(e.substr(1));
									...
									for ("=" === e.charAt(0) && (e = "defaultattr" + e); (t = n.exec(e)); )
										o[i(t[1])] = E(t[3]) || t[4];
								return o;
							})(n[2]))),
					e === N && (n = t.match(/\[\/([^\[\]]+)\]/)) && (r = i(n[1])),
					e === M && (r = "#newline"),
					(r && ((e !== T && e !== N) || w[r])) || ((e = D), (r = "#")),
					new c(e, r, t, o)
				);
							...
							for (; (t = e.shift()); )
								switch (
									...
									case T:
										f(t.name) && c.pop(),
											d(t),
											(n = w[t.name]) && !n.isSelfClosing && (n.closedBy || p(t.name, N, e))
												? c.push(t)
												: (n && n.isSelfClosing) || (t.type = D);
										break;
									case N:
										if (
											(u() && t.name !== u().name && f("/" + t.name) && c.pop(),
											u() && t.name === u().name)
										)
											(u().closing = t), c.pop();
									...
									case M:
										u() &&
											l &&
											f((l.type === N ? "/" : "") + l.name) &&
											((l.type === N && l.name === u().name) ||
												((n = w[u().name]) && n.breakAfter
													? c.pop()
													: n &&
													  !1 === n.isInline &&
													  h.opts.breakAfterBlock &&
													  !1 !== n.breakAfter &&
													  c.pop())),
											d(t);
										break;
									...
									if ((i = t[l]) && i.type === T) {
										if (o && !d(i)) {
											if (
												((a = v(n)),
												(u = a.splitAt(i)),
												(c = 1 < n.length ? n[n.length - 2].children : r),
												m(i, a))
											) {
												var f = a.clone();
											...
											if (-1 < (s = c.indexOf(a))) {
												...
												return void (
													p &&
													p.type === M &&
													(d(i) || (u.children.splice(0, 1), c.splice(s + 2, 0, p)))
												);
											}
										}
											...
											!o &&
												...
												(i
													? c ||
													  l ||
													  (!1 === a.isInline &&
															h.opts.breakEndBlock &&
															!1 !== a.breakEnd &&
															(d = !0),
													  a.breakEnd && (d = !0),
													  (c = d))
													: (!1 === a.isInline &&
															h.opts.breakStartBlock &&
															!1 !== a.breakStart &&
															(d = !0),
													  a.breakStart && (d = !0))),
											i &&
								...
								for (; i--; )
									(n = t[i]) &&
										...
										r(n.children) &&
											...
											!o.isSelfClosing &&
											!o.allowsEmpty &&
											t.splice.apply(t, [i, 1].concat(n.children)));
							})(n),
						n
					);
				}),
				(h.toHTML = function (e, t) {
					return (function e(t, n) {
						...
						for (; 0 < t.length; )
							if ((o = t.shift())) {
								if (o.type === T)
									(u = o.children[o.children.length - 1] || {}),
										(r = w[o.name]),
										(a = n && c(r)),
										(i = e(o.children, !1)),
										r && r.html
											? (c(r) ||
													...
													(i += "<br />"),
											  C(r.html)
													? (l = r.html.call(h, o, o.attrs, i))
													: ((o.attrs[0] = i), (l = k(r.html, o.attrs))))
											: (l = o.val + i + (o.closing ? o.closing.val : ""));
								else {
									if (o.type === M) {
										if (!n) {
											d.push("<br />");
						...
						for (; 0 < t.length; )
							if ((n = t.shift()))
								if (
									...
									(l = r && r.isSelfClosing),
									(s =
										(i && h.opts.breakBeforeBlock && !1 !== r.breakBefore) || (r && r.breakBefore)),
									(c =
										(i && !l && h.opts.breakStartBlock && !1 !== r.breakStart) ||
										(r && r.breakStart)),
									(u = (i && h.opts.breakEndBlock && !1 !== r.breakEnd) || (r && r.breakEnd)),
									(d = (i && h.opts.breakAfterBlock && !1 !== r.breakAfter) || (r && r.breakAfter)),
									(a = (r ? r.quoteType : null) || h.opts.quoteType || x.auto),
									r || n.type !== T)
								)
									if (n.type === T) {
										if ((s && f.push("\n"), f.push("[" + n.name), n.attrs))
											for (o in (n.attrs.defaultattr &&
												(f.push("=", g(n.attrs.defaultattr, a, "defaultattr")),
												delete n.attrs.defaultattr),
											n.attrs))
												n.attrs.hasOwnProperty(o) && f.push(" ", o, "=", g(n.attrs[o], a, o));
										f.push("]"),
											c && f.push("\n"),
											n.children && f.push(e(n.children)),
											l || r.excludeClosing || (u && f.push("\n"), f.push("[/" + n.name + "]")),
											d && f.push("\n"),
									...
									f.push(n.val),
										n.children && f.push(e(n.children)),
										n.closing && f.push(n.closing.val);
						return f.join("");
					})(h.parse(e, t));
				});
		}
		function l(e) {
			return (
				(e = parseInt(e, 10)),
				isNaN(e) ? "00" : (e = Math.max(0, Math.min(e, 255)).toString(16)).length < 2 ? "0" + e : e
			);
		}
		function u(e) {
			var t;
			return (t = (e = e || "#000").match(/rgb\((\d{1,3}),\s*?(\d{1,3}),\s*?(\d{1,3})\)/i))
				? "#" + l(t[1]) + l(t[2]) + l(t[3])
				: (t = e.match(/#([0-f])([0-f])([0-f])\s*?$/i))
		...
		function d() {
					...
					a[(e = !!e)] &&
						s(a[e], function (e, t) {
							(r = l(n, e)) &&
								l(n.parentNode, e) !== r &&
								s(t, function (e, t) {
									(!t || -1 < t.indexOf(r.toString())) &&
										((i = w[e].format), (o = C(i) ? i.call(c, n, o) : S(i, o)));
								});
						}),
					o
				);
					...
					return (
						h.traverse(
							...
							function (e) {
								...
								if (
									("object" == typeof a &&
										((l = -1 < a.indexOf(o)), v(e, "img") && g(e, b) && (l = !0), l || (r = a)),
									3 === n || 1 === n)
								)
									if (1 === n) {
										if (
											v(e, ".sceditor-nlf") &&
											(!i || (!y && 1 === e.childNodes.length && /br/i.test(i.nodeName)))
										)
											return;
										"iframe" !== o && (t = c(e, r)),
											l
												? ("code" !== o && (t = d(e, (t = f(e, (t = d(e, t)))), !0)),
												  (t = f(e, t, !0)),
												  (s += (function (e, t) {
														...
														if (!o(e, !0) || "br" === n) {
															...
															for (
																;
																(r = ((i = e.parentNode) && i.lastChild) === e),
																	(e = i) && r && o(i, !0);
			...
			function e(e, t, n) {
				var o,
					...
					l,
					a,
					s = new B(c.opts.parserOptions).toHTML(c.opts.bbcodeTrim ? t.trim() : t);
				return e || n
					? ((o = s),
							...
							if (!h.hasStyling(e)) {
								...
								if (t) {
									...
									e !== n &&
										v(n, "div") &&
										e.nextSibling === n &&
										a.insertBefore(document.createElement("br"), e);
								}
								a.removeChild(e);
							}
					  }),
					  m(a, "display", "none"),
					  (a.innerHTML = o.replace(/<\/div>\n/g, "</div>")),
					  (r = a.firstChild) && v(r, "div") && l(r, !0),
					  (r = a.lastChild) && v(r, "div") && l(r),
					  a.innerHTML)
					: s;
			}
			function t(e, t, n, o) {
				var r,
					i,
					l = (n = n || document).createElement("div"),
					a = n.createElement("div"),
					s = new B(c.opts.parserOptions);
				for (
					a.innerHTML = t,
						m(l, "visibility", "hidden"),
						l.appendChild(a),
						n.body.appendChild(l),
						e &&
							(l.insertBefore(n.createTextNode("#"), l.firstChild), l.appendChild(n.createTextNode("#"))),
						o && m(a, "whiteSpace", m(o, "whiteSpace")),
						i = a.getElementsByClassName("sceditor-ignore");
					i.length;

				)
					i[0].parentNode.removeChild(i[0]);
				return (
					h.removeWhiteSpace(l),
					(r = p(a)),
					n.body.removeChild(l),
					(r = s.toBBCode(r, !0)),
					c.opts.bbcodeTrim && (r = r.trim()),
					r
				);
			}
			(c.init = function () {
				(c.opts = this.opts),
					...
					(this.toBBCode = c.toSource),
					(this.fromBBCode = c.toHtml);
			}),
				(c.toHtml = e.bind(null, !1)),
				(c.fragmentToHtml = e.bind(null, !0)),
				(c.toSource = t.bind(null, !1)),
				(c.fragmentToSource = t.bind(null, !0));
		}
		(c.prototype = {
			clone: function () {
				var e = this;
