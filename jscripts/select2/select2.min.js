				...
				window.clearTimeout(d),
					(d = window.setTimeout(function () {
						...
						(d = d ? d.call(h, i.term, i.page, i.context) : null),
							...
							c.params &&
								(a.isFunction(c.params) ? a.extend(l, c.params.call(h)) : a.extend(l, c.params)),
							a.extend(l, {
								url: f,
								dataType: c.dataType,
								data: d,
					...
					destroy: function () {
						...
						this.close(),
							...
							this.propertyObserver &&
								(this.propertyObserver.disconnect(), (this.propertyObserver = null)),
							(this._sync = null),
							c !== b &&
								(c.container.remove(),
								c.liveRegion.remove(),
										...
										(h = function (d, e, l) {
											...
											for (m = 0, n = d.length; n > m; m += 1)
												(o = d[m]),
													...
													s.addClass(
														p ? "select2-result-selectable" : "select2-result-unselectable",
													),
								...
								e.find(".select2-no-results,.select2-selection-limit,.select2-searching").length
									...
									: h.liveRegion.text(
											h.opts.formatMatches(
												e.find('.select2-result-selectable:not(".select2-selected")').length,
											),
									  );
						}
						function n(a) {
						...
						this.opts.minimumResultsForSearch >= 0 && this.showSearch(!0),
							...
							this.opts.shouldFocusInput(this) &&
								...
								b.createTextRange
									...
									: b.setSelectionRange &&
									  ((d = this.search.val().length), b.setSelectionRange(d, d))),
				...
				(e = O(c, {
								...
								this.bind(function (a) {
									if (this.isInterfaceEnabled()) {
										...
										if (
											...
											return (
												this.selectChoice(
													c.find(".select2-search-choice:not(.select2-locked)").last(),
												),
												A(a),
												void 0
											);
										if ((this.selectChoice(null), this.opened()))
											switch (a.which) {
												...
												case k.TAB:
													return (
														this.selectHighlighted({ noFocus: !0 }), this.close(), void 0
													);
												case k.ESC:
													return this.cancel(a), A(a), void 0;
											}
					...
					createChoice: function (c) {
						var i,
							...
							h = this.id(c);
						return (
							(i = this.opts.formatSelection(c, g.find("div"), this.opts.escapeMarkup)),
