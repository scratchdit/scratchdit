	...
	function addAttachmentBox(e) {
		...
		var next_count = Number(attachedCount) + 1,
			contents =
				...
				attachedCount +
				'"><img src="styles/default/images/icons/cross.png" alt="' +
				delete_lang_string +
				'" title="' +
				delete_lang_string +
				'" /></a></span>' +
				file_lang_string +
				' &nbsp;<input type="text" name="attached_' +
				attachedCount +
				'" value="" class="text_input" style="width: 200px;" id="attached_' +
				attachedCount +
				'" /></div>\n</td>\n</tr>\n<tr class="last alt_row">\n<td class="first"><div class="form_row"><dl style="margin-top: 0; margin-bottom: 0; width: 100%;">\n<dt><label style="display: block;"><input type="radio" name="action_' +
				attachedCount +
				'" value="0" checked="checked" class="action_' +
				attachedCount +
				's_check" onclick="checkAction(\'action_' +
				attachedCount +
				'\');" style="vertical-align: middle;" /> ' +
				globally_lang_string +
				'</label></dt>\n<dt><label style="display: block;"><input type="radio" name="action_' +
				attachedCount +
				'" value="1"  class="action_' +
				attachedCount +
				's_check" onclick="checkAction(\'action_' +
				attachedCount +
				'\');" style="vertical-align: middle;" /> ' +
				specific_actions_lang_string +
				'</label></dt>\n<dd style="margin-top: 4px;" id="action_' +
				attachedCount +
				'_1" class="action_' +
				attachedCount +
				's">\n<small class="description">' +
				specific_actions_desc_lang_string +
				'</small>\n<table cellpadding="4">\n<tr>\n<td><input type="text" name="action_list_' +
				attachedCount +
				'" value="" class="text_input" style="width: 190px;" id="action_list_' +
				attachedCount +
				'" /></td>\n</tr>\n</table>\n</dd>\n</dl></div>\n</td>\n</tr>\n</tbody>\n</table>\n</div></div><div id="attach_box_' +
				next_count +
				'"></div>\n';
